class Item:
    ...
    def __str__(self):
        return "(Name: " + self.name + ", scrapper: " + self.scrapper + ", URL: " + self.url + " , threshold: " + str(self.threshold) + ", base price: " + str(self.base_price) + ", current price: " + str(self.current_price) + ", discount: " + str(self.discount) + ")"
